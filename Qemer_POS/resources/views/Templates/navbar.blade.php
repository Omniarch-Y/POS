<div class="home_content" style="float:right;">
    <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm mt-4" style="border-radius:20px; margin-left:20px; margin-right:20px">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="navbar-item position-relative mx-4" style="margin-top:8px;">
                        <a type="" data-bs-toggle="modal" data-bs-target="#addCategory" class="bi fs-5  bi-cart text-dark">
                        <span class="position-absolute mx-2 text-small top-0 start-100 translate-middle badge rounded-pill bg-danger">
                           {{$cartTotal}}
       ...
       <div class="modal-content">
          ...
          <form method="POST" action="{{'receipt'}}">
             ...
             <div class="row align-items-center justify-content-center ">
                 ...
                 <div class="col mx-0 ">
                     <input type="text" class=" col-md-5 form-control mx-auto my-4" name="Tin_number" placeholder="Enter customer tin number"/>
                 </div>
                </div>
                 </div>
             </div>
             <div class="container">
                <div class="row align-items-center justify-content-center ">
                   <button class=" mx-auto btn btn-primary">Proceed</button>
                </div>
             </div>
