    ...
    <div class="row align-items-center ">
        <div class="col-md-8 mx-auto ">
           ...
           <div class=" card ">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ 'updateItem/'.$stock->id }} " enctype="multipart/form-data">
                        @csrf
                        @method("PATCH")
                        ...
                        <div class="form-group row py-3">
                            ...
                            <div class="col-md-6">
                                <input id="total_amount"  placeholder="{{ __('Enter how many numbers in stock it will have') }}" type="number" class="form-control @error('total_amount') is-invalid @enderror" name="total_amount" value="{{ old('total_amount') }}" value={{$stock->total_amount }}autocomplete="total_amount" required>
                        ...
                        <div class="form-group row py-3">
                            ...
                            <div class="col-md-6">
                                <input id="price"  type="number" class="form-control @error('price') is-invalid @enderror" name="price" value="{{ old('price') }}" autocomplete="price" placeholder="{{ __('Enter the price in ETB') }}  " value={{$stock->price}} required>
